...
#-----------for checking user is doctor , patient or adminfrom django.shortcuts import render, redirect, reverse
from . import forms, models
from django.db.models import Sum
from django.contrib.auth.models import Group
from django.http import HttpResponseRedirect
...
def doctor_signup_view(request):
    ...
    my_dict = {'user_form': user_form, 'doctor_form': doctor_form}
    if request.method == 'POST':
...
def patient_signup_view(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and patient_form.is_valid():
            ...
            my_patient_group[0].user_set.add(user)
        return HttpResponseRedirect('patientlogin')
    return render(request, 'hospital/patientsignup.html', context=my_dict)
...
def admin_dashboard_view(request):
    ...
    return render(request, 'hospital/admin_dashboard.html', context=my_dict)
...
def update_doctor_view(request, pk):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and doctor_form.is_valid():
            ...
            doctor.save()
            return redirect('admin-view-doctor')
    return render(request, 'hospital/admin_update_doctor.html', context=my_dict)
...
def admin_add_doctor_view(request):
    ...
    return render(request, 'hospital/admin_add_doctor.html', context=my_dict)
